...
DEFAULT_ACHIEVEMENTS = [
    ...
    Achievement.new("Prophetic Medicine", "Use Black Seed to cure the boy", "The Messenger of Allah said: 'Use black seed. For indeed it contains a cure for every disease except death.' [At-Tirmidhi]"),
